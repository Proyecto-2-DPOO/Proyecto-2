package open.dpoo.view;

import open.dpoo.controller.AccountManager;
import open.dpoo.exception.AccountException;
import open.dpoo.exception.InvalidInputException;
import open.dpoo.model.galeria.Auction;
import open.dpoo.model.galeria.Inventory;
import open.dpoo.model.galeria.piece.*;
import open.dpoo.model.usuarios.Administrator;
import open.dpoo.model.usuarios.Author;
import open.dpoo.model.usuarios.BaseUser;
import open.dpoo.model.usuarios.Cashier;
import open.dpoo.model.usuarios.Operator;
import open.dpoo.model.usuarios.Owner;
    ...
    private Piece collectInput(String title, int year, Locale origin, List<Author> authorsList, String description,
        ...
        if (type.contains("pint")) {
            ...
            return new Painting(Inventory.getId(), title, year, origin, authorsList, description, availability,
                    valoration, storage, width, height, style);
